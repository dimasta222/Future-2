...
- size-aware oversize print area resolution: выбранный размер управляет real mockup source, координатами preview print-area и физическими лимитами размеров; если у размера нет PNG, используется SVG fallback
