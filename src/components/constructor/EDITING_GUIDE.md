...
- src/components/constructor/constructorConfig.js
  ...
  - если нужно поменять состав каталога категорий, горизонтальных лент и SVG-логику внутренней обводки

- src/hooks/useConstructorState.js
  - если нужно поменять shape-layer props
  - если нужно поменять создание, дублирование, summary, размеры upload/preset/shape в сантиметрах, выбор активной фигуры, стартовое смещение новых слоёв, привязку слоя к стороне «Спереди/Сзади» или параметры эффектов
