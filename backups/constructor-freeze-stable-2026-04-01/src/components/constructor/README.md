...
- хранение размеров upload, preset и shape-layer в сантиметрах относительно физической зоны печати 40 × 50 см и показ этих размеров в sidebar
...
- отдельный line-special-case: линейные фигуры сохраняют свою пропорцию внутри контейнера и не переходят в свободное растяжение как обычные shape-layer
- загрузку файла
