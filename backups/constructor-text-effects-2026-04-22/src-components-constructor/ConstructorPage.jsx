...
export default function ConstructorPage({ onBack, products, onOpenProductDetails, initialSelection }) {
  ...
  const [showTextInkGuide, setShowTextInkGuide] = useState(false);
