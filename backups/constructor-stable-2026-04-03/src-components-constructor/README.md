...
- разное стартовое смещение для новых текстовых, shape- и upload-слоёв, чтобы добавление нового элемента было заметно сразу на превью
...
- показывает sticky shape-toolbar для активного shape-layer даже если левая колонка открыта на другой вкладке, и временно подменяет содержимое левой колонки shape-панелью по командам toolbar без принудительного переключения вкладки
